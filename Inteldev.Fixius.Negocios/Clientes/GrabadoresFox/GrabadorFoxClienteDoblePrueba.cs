...
{
    public class GrabadorFoxClienteDoblePrueba : IGrabadorFox<Cliente>
    {
        protected string usuario;
        public bool Borrar(Cliente entidad)
        {
            var grabadorPreventa = new GrabadorFoxCliente(new DaoFoxPrueba());
            grabadorPreventa.Usuario = usuario;
            
            var ok = grabadorPreventa.Borrar(entidad);
            
            var grabadorMayorista = new GrabadorFoxCliente(new DaoFoxPruebaMayorista());
