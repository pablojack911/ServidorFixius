...
{
    /// <summary>
    /// Validador para GeoRegionDeVenta, que en Fox viene de la tabla "regiones" junto con RegionDeVenta.
    /// </summary>
    class ValidadorGeoRegionDeVenta : ValidadorGenerico<GeoRegionDeVenta>
    {
        public override bool isRepetido(GeoRegionDeVenta entidad, string empresa)
        {
